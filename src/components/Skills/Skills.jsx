      ...
      <div className="container" id="skills">
        ...
        <div className="container skills">
          <div className="row d-flex justify-content-center">
            <div className="col-lg-2 col-sm-2 text-center" data-aos="zoom-in" data-aos-duration="3000">
            ...
            <div className="col-lg-2 col-sm-2 text-center" data-aos="zoom-in" data-aos-duration="3000">
              <div className="ui-widgets ui-widgetsreact">
                <div className="ui-values">
                  <img src={require("../../assets/vue.png")} alt="" />
                </div>
                <div className="ui-labels">Vue.JS</div>
              </div>
            </div>
          </div>
        </div>
